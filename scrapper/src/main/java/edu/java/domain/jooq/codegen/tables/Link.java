...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super Long, ? super String, ? super Integer, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super Long, ? super String, ? super Integer, ? super OffsetDateTime, ? extends U> from) {
