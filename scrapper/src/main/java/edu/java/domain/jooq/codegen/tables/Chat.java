...
public class Chat extends TableImpl<ChatRecord> {
     ...
     */
    public final TableField<ChatRecord, Integer> STATE =
        createField(DSL.name("STATE"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>CHAT.LAST_UPDATE_AT</code>.
     */
    public final TableField<ChatRecord, OffsetDateTime> LAST_UPDATE_AT =
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function3<? super Long, ? super Integer, ? super OffsetDateTime, ? extends U> from
    ) {
